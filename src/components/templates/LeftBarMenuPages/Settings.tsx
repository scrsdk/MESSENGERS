...
import { logout, openModal, toaster, uploadFile } from "@/utils";
    ...
    openModal({
      ...
      onSubmit: async () => {
        try {
          ...
          setIsLoading(false);
          toaster(false, "Failed to upload, check your network btw.");
        }
      },
      ...
      <div className="relative -mx-4">
        <div className="absolute px-4 inset-x-0 w-full">
          <div className="flex items-center gap-3 my-3">
            {
              <div
                className={`flex-center relative size-[55px] ${
              ...
              >
                {avatar || uploadedImageUrl ? (
                  ...
                  <div className="flex-center bg-darkBlue shrink-0 text-center font-bold text-2xl">
                    {name?.length && name![0]}
                  </div>
                )}
